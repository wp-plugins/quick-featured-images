...
<form method="post" action="<?php echo admin_url( sprintf( 'upload.php?page=%s&amp;step=refine', $this->plugin_slug ) ); ?>">
	<fieldset>
		<legend><span><?php _e( 'Choose filters', $this->plugin_slug ); ?></span></legend>
		<p><?php _e( 'You can select multiple filters. They will be combined with the AND operator and will result in an intersection of the filters.', $this->plugin_slug ); ?></p>
<?php 
